...
function Dungeons:OperationMechagon()
  ...
  self:RegisterRaidInstance(dungeonTierId, operationmechagon, name, bonusIds)
  --------------------------------------------------
  ----- Operation: Mechagon
  --------------------------------------------------
...
function Dungeons:InitializeZoneDetect(ZoneDetect)
  ...
  local mechagon = "operationmechagon"
  ZoneDetect:RegisterMapID(1490, operationmechagon)
  ZoneDetect:RegisterNPCID(150159, operationmechagon, 1)
  ZoneDetect:RegisterNPCID(150222, operationmechagon, 2)
  ZoneDetect:RegisterNPCID(155407, operationmechagon, 3)
  ZoneDetect:RegisterNPCID(155406, operationmechagon, 3)
  ZoneDetect:RegisterNPCID(155157, operationmechagon, 4)
  ZoneDetect:RegisterNPCID(144244, operationmechagon, 5)
  ZoneDetect:RegisterNPCID(144246, operationmechagon, 6)
  ZoneDetect:RegisterNPCID(144248, operationmechagon, 7)
  ZoneDetect:RegisterNPCID(154817, operationmechagon, 8)
